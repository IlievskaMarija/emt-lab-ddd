package mk.ukim.finki.emt.lab.rest.client;
...
@Service
class MovieCatalogClient implements MovieCatalog {

    private static final Logger LOGGER = LoggerFactory.getLogger(MovieCatalogClient.class);

    private final RestTemplate restTemplate;
    private final String serverUrl;

    MovieCatalogClient(@Value("${app.product-catalog.url}") String serverUrl,
